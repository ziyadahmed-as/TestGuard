...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='uploaded_by',
            field=models.ForeignKey(help_text='Administrator who initiated the import operation', limit_choices_to={'role': 'ADMIN'}, on_delete=django.db.models.deletion.CASCADE, related_name='user_imports', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='course',
            name='department',
        ...
        migrations.AddIndex(
            model_name='bulkuserimport',
            index=models.Index(fields=['status', 'uploaded_by'], name='core_bulkus_status_adb76c_idx'),
        ),
        migrations.AddIndex(
            model_name='bulkuserimport',
            index=models.Index(fields=['created_at'], name='core_bulkus_created_65c541_idx'),
        ),
        migrations.AddIndex(
            model_name='course',
