...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session_token', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique identifier for this active session')),
                ('started_at', models.DateTimeField(auto_now_add=True, help_text='Timestamp when the session started')),
                ('last_activity', models.DateTimeField(auto_now=True, help_text='Timestamp of the last activity in this session')),
                ('is_active', models.BooleanField(default=True, help_text='Indicates whether this session is currently active')),
                ('risk_level', models.CharField(choices=[('low', 'Low'), ('medium', 'Medium'), ('high', 'High')], default='low', help_text='Current risk level assessment for this session', max_length=10)),
                ('device_session', models.ForeignKey(help_text='Device session used for this exam attempt', on_delete=django.db.models.deletion.CASCADE, related_name='active_exam_sessions', to='core.userdevicesession')),
                ('user', models.ForeignKey(help_text='User participating in the exam session', on_delete=django.db.models.deletion.CASCADE, related_name='exam_active_sessions', to=settings.AUTH_USER_MODEL)),
                ('exam', models.ForeignKey(help_text='Exam associated with this active session', on_delete=django.db.models.deletion.CASCADE, related_name='exam_active_sessions', to='exams.exam')),
                ('attempt', models.OneToOneField(help_text='Specific exam attempt associated with this session', on_delete=django.db.models.deletion.CASCADE, related_name='exam_active_session', to='exams.examattempt')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'exam'], name='exams_activ_user_id_0627ca_idx'),
        ),
        migrations.AddIndex(
            model_name='activeexamsession',
            index=models.Index(fields=['session_token'], name='exams_activ_session_f85973_idx'),
        ),
        migrations.AddIndex(
            model_name='activeexamsession',
            index=models.Index(fields=['is_active'], name='exams_activ_is_acti_33980a_idx'),
        ),
        migrations.AddIndex(
            model_name='activeexamsession',
            index=models.Index(fields=['risk_level'], name='exams_activ_risk_le_99c563_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='activeexamsession',
